#ifndef TM_DAHENGUSBAREASCANCAMERA_H
#define TM_DAHENGUSBAREASCANCAMERA_H
#ifdef GLOBAL_DAHENG
...
class TM_DahengUsbAreaScanCamera : public AbstractCamera
{
    Q_OBJECT

public:
    explicit TM_DahengUsbAreaScanCamera(const QString &cameraSN, int cameraId);
    virtual ~TM_DahengUsbAreaScanCamera();
...
public:
    ...
    /* 相机设备的前置操作 */
    static bool enumDevices(QList<QString> &cameraInfoList);                 //枚举相机设备
    bool isAreaLScan();
...
protected:
    std::shared_ptr<DahengUsbAreaCamera> m_cameraHandle;

};

#endif // GLOBAL_DAHENG
#endif // TM_DAHENGUSBAREASCANCAMERA_H
